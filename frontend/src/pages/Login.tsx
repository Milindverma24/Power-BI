...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden bg-background">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-accent-indigo/20 blur-[120px] rounded-full pointer-events-none" />
      ...
      <div className="w-full max-w-md animate-slide-up">
        <div className="bento-card p-8 sm:p-10 relative z-10">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-muted text-center">Enter your details to access your AI BI workspace.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1">
              <label className="text-sm font-medium text-main ml-1">Email</label>
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center ml-1">
                ...
                <Link to="/forgot-password" className="text-xs text-accent-primary hover:text-accent-primary transition-colors">Forgot password?</Link>
              </div>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-muted">
                  <Lock size={18} />
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 bg-surface/50 border border-border-theme rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-accent-indigo transition-all text-main placeholder-slate-500 outline-none"
                  placeholder="••••••••"
                />
                <button
                  type="button"
                  onClick={() => setShowPassword(!showPassword)}
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-muted hover:text-main transition-colors focus:outline-none"
            ...
            <div className="relative flex items-center py-2">
              <div className="flex-grow border-t border-border-theme"></div>
